...
[Documentation](../README.md) · [Configuration example](../examples/model-gateway.yaml)
...
![Model routing and fallback sequence](../assets/diagrams/model-routing-sequence.svg)
