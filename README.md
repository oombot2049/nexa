...
![NexaPilot durable run lifecycle](docs/assets/diagrams/run-lifecycle.svg)
...
![NexaPilot system architecture](docs/assets/diagrams/system-architecture.svg)
...
- [First agent run](docs/getting-started/first-agent-run.md)
- [System architecture](docs/architecture/overview.md)
- [Configuration reference](docs/reference/configuration.md)
- [Database schema](docs/reference/database-schema.md)
- [Provider compatibility](docs/reference/provider-compatibility.md)
